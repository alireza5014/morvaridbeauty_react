...
export default class AboutUs extends Component {
    ...
    componentDidMount() {
        fetch(process.env.REACT_APP_API_URL + '/about_us')
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-7 col-md-6">
                                <div className="section-title mb-0 mr-0 mr-md-4">
                                    <h4 className="title text-uppercase mb-4">{this.state.data.title}</h4>
                            ...
                            <div className="col-lg-5 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="position-relative">
                                    <img src={process.env.REACT_APP_BASE_URL + data.image_path}
